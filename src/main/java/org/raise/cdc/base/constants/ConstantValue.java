...
package org.raise.cdc.base.constants;
...
public class ConstantValue {
    ...
    public static final String CDC_EROOR_SPECIAL = "special";
    public static final String CDC_EROOR_COMMON = "common";
    public static final String CDC_EROOR_OTHER = "other";
}
